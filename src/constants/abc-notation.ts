/**
 * Default ABC notation loaded when the app starts.
 * Contains "Sempre Teu" by Jacob do Bandolim - a Brazilian choro piece.
 * This demonstrates multi-part structure (ABBACA), chord symbols, and articulations.
 */
export const DEFAULT_ABC_NOTATION = `% Generated by abctools on 2025-11-30T00:08:21.818Z
% header layout
